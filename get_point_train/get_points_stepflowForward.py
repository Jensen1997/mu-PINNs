...
def parse_args():
    ...
    parser.add_argument('--flength', type=float, default=1, help='Forward Length of step')
    parser.add_argument('--blength', type=float, default=0, help='Backward Length of step')
...
if __name__ == "__main__":
    ...
    if flength == 0:
        ...
        scenario = scenario+'Column'

        '''UP and DOWN'''
        UP = [xmin, ymax] + [xmax-xmin, 0] * lhs(2, 500)
        Down_1 = [xmin, ymin] + [flength, 0] * lhs(2, 100)
        Down_2 = [xmin+flength, ymin] + [0, height] * lhs(2, 100)
        Down_3 = [xmin+flength, ymin+height] + [xmax-xmin-flength-blength, 0] * lhs(2, 100)
        Down_4 = [xmax-blength, ymin] + [0, height] * lhs(2, 100)
        Down_5 = [xmax-blength, ymin] + [blength, 0] * lhs(2, 100)
        ...
        '''INNER'''
        Inner_1 = [xmin, ymin] + [flength, ymax-ymin] * lhs(2, 14000)
        Inner_2 = [xmin+flength, ymin+height] + [xmax-xmin-flength-blength, ymax-ymin-height] * lhs(2, 5000)
        Inner_3 = [xmax-blength, ymin] + [blength, ymax-ymin] * lhs(2, 14000)
        Inner_1_refine = [xmin+flength, ymin] + [-0.3, height+0.3] * lhs(2, 1000)
        Inner_2_refine = [xmin+flength-0.3, ymin+height] + [xmax-xmin-flength-blength+0.6, 0.3] * lhs(2, 1000)
        Inner_3_refine = [xmax-blength, ymin] + [0.3, height+0.3] * lhs(2, 1000)
